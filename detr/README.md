...
##ローカルテスト用
python detr/main.py --coco_path "S:/coco/coco2017" --depth_path "S:/coco/coco2017_depth" --use_depth --resume "/workspace/DETR/weights/detr-r50-e632da11.pth" --output_dir DETR/detr/test --debug --epochs 10 --lr 1e-4 --lr_backbone 1e-5 --batch_size 4 --num_workers 8  --val_split --use_sharefusion True
